...
tangram(formula, rhc, "unmatched", smd, "Unmatched", style="nejm", relsize=-2, test=TRUE)
```
...
tangram(formula, rhcMatched, "matched", smd, "Propensity Score Matched", style="nejm", relsize=-2)
```
...
tangram(formula, rhc, "weighted", smd,
        ...
        style="nejm",
        weight=rhc$pMin/rhc$pAssign, relsize=-2)
```
